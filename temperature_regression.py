...
data = pd.read_excel('timeseries_newyork.xlsx', header=None)
data = np.array(data)
...
x_train = data[:split_line_number, :7]
x_test = data[split_line_number:, :7]
y_train = data[:split_line_number, 7]
y_test = data[split_line_number:, 7]
...
for i in range(epochs):
    ...
    o1 = np.zeros((l1_neurons, l2_neurons))
